...
public class WorldGenMinableEnd extends WorldGenerator
{
    ...
    public WorldGenMinableEnd(IBlockState p_i45630_1_, int p_i45630_2_)
    {
        this(p_i45630_1_, p_i45630_2_, BlockHelper.forBlock(Blocks.end_stone));
    }

    public WorldGenMinableEnd(IBlockState p_i45631_1_, int p_i45631_2_, Predicate p_i45631_3_)
    {
