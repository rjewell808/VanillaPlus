...
{
public Item placerItem = VanillaPlus.darkOakDoorItem;
...
public BlockDarkOakDoor(Material par2Material)
    {
    super(par2Material);
    float f = 0.5F;
    float f1 = 1.0F;
...
public Item getItemDropped(int metadata, Random rand, int fortune){
	return VanillaPlus.darkOakDoorItem;
}
...
public void registerBlockIcons(IIconRegister p_149651_1_)
{
    ...
    this.field_150017_a[0] = p_149651_1_.registerIcon("VanillaPlus:"+this.getUnlocalizedName().substring(5)+"_upper");
    this.field_150016_b[0] = p_149651_1_.registerIcon("VanillaPlus:"+this.getUnlocalizedName().substring(5)+"_lower");
