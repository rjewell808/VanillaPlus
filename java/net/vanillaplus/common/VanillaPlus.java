...
import net.vanillaplus.helpers.MobDropHandler;
...
//ARMOR
public static ArmorMaterial armorObsidian = EnumHelper.addArmorMaterial("OBSIDIAN", 66, new int[] {3, 8, 7, 2}, 8);
public static ArmorMaterial armorEmerald = EnumHelper.addArmorMaterial("EMERALD", 30, new int[] {3, 6, 4, 2}, 13);
public static ArmorMaterial armorEnder = EnumHelper.addArmorMaterial("ENDER", 40, new int[] {3, 6, 6, 2}, 15);
public static ArmorMaterial armorWater = EnumHelper.addArmorMaterial("WATER", 15, new int[] {2, 6, 5, 2}, 9);
public static ArmorMaterial armorScorched = EnumHelper.addArmorMaterial("SCORCHED", 30, new int[] {3, 5, 4, 2}, 12);
public static ArmorMaterial armorRuby = EnumHelper.addArmorMaterial("RUBY", 35, new int[] {2, 7, 5,2}, 25);
public static ArmorMaterial armorSapphire = EnumHelper.addArmorMaterial("SAPPHIRE", 35, new int[] {2, 7, 5, 2}, 20);
public static ArmorMaterial armorGuardian = EnumHelper.addArmorMaterial("GUARDIAN", 1, new int[] {2, 4, 3, 2}, 4);
...
//Block Properties
        ...
        xpOre = new BlockXpOre(Material.iron).setHardness(4.0f).setLightLevel(0.4F).setBlockName("xpOre");
...
/////////////////////////////////////////
        ...
        seasonedFlesh = new ItemSeasonedFlesh(6, 0.1F, true).setUnlocalizedName("seasonedFlesh");
        ...
        toast = new ItemToast(6, 0.1F, false).setUnlocalizedName("toast");
